...
source=(
  "${pkgname}-${pkgver}.tar.gz::https://github.com/tux4kids/tuxtype/archive/refs/tags/upstream/${pkgver}.tar.gz"
  "missing_texts.patch"
)
sha256sums=('c1abea756ad8fa1e9217f9dea63e7de5fe536022c6984dc438c65d9a1afb92bb'
            '6cfa7025ef1ac6b2be436876e7dd11b03a503dbcea6b15eee04fa18fc2afc97e')
